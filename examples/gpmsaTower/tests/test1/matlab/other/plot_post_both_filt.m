...
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,1),'function','pdf');
...
print -dpng post_13_param01_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,2),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param02_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,3),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param03_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,4),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param04_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,5),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param05_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,6),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param06_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,7),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param07_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,8),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param08_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,9),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param09_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,10),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param10_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,11),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param11_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,12),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param12_both_filt.png
waitforbuttonpress;
clf;
...
[g,gi] = ksdensity(chain(:,1),'function','pdf');
plot(gi,g,'-r','linewidth',2);
[f,xi] = ksdensity(gcm_mh_filtChain_unified(:,13),'function','pdf');
plot(xi,f,'-b','linewidth',2);
...
ylabel('Marginal posterior KDE (BOTH + filter)');
print -dpng post_13_param13_both_filt.png
waitforbuttonpress;
clf;
