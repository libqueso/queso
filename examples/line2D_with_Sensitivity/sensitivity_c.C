...
Qoi_c<P_V, P_M, Q_V, Q_M>::Qoi_c(const char * prefix,
...
template<class P_V, class P_M, class Q_V, class Q_M>
void
Qoi_c<P_V, P_M, Q_V, Q_M>::compute(const P_V & domainVector,
...
//  std::cout << "m = " << domainVector[0] << std::endl; 
  double m = 3.0;  // Sample of the RV 'line slope'
...
template class Qoi_c<QUESO::GslVector, QUESO::GslMatrix, QUESO::GslVector,
                   QUESO::GslMatrix>;
