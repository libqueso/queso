function varargout = autocorr_local(Series , nLags , Q , nSTDs)
...
fprintf(1,'\t Using autocorr function from "http://sfb649.wiwi.hu-berlin.de/quantnet/index.php?p=show&id=900" \n');
