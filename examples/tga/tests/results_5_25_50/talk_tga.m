...
grid on;
set(gca,'fontsize',20);
print -dpng talk_tga_s1_prior_0.png
waitforbuttonpress;
clf
...
grid on;
set(gca,'fontsize',20);
print -dpng talk_tga_s1_prior_1.png
waitforbuttonpress;
clf
...
print -dpng talk_tga_s1_s2_post_mpdf_0.png
waitforbuttonpress;
clf
...
print -dpng talk_tga_s1_s2_post_mpdf_1.png
waitforbuttonpress;
clf
...
legend('Calibration',...
       'Validation',...
       'location','northwest');
print -dpng talk_tga_s1_s2_qoi_mpdf_0.png
waitforbuttonpress;
clf
...
legend('Calibration',...
       'Validation',...
       'location','northwest');
print -dpng talk_tga_s1_s2_qoi_cdf_0.png
waitforbuttonpress;
clf
...
legend('Calibration',...
       'Validation',...
       'location','northwest');
print -dpng talk_tga_s1_s2_qoi_cdf_0_model_confidence_a.png
waitforbuttonpress;
clf
...
legend('Calibration',...
       'Validation',...
       'location','northwest');
print -dpng talk_tga_s1_s2_qoi_cdf_0_model_confidence_b.png
waitforbuttonpress;
clf
...
legend('Calibration',...
       'Validation',...
       'location','northwest');
print -dpng talk_tga_s1_s2_qoi_cdf_0_system_confidence_a.png
waitforbuttonpress;
clf
...
legend('Calibration',...
       'Validation',...
       'location','northwest');
print -dpng talk_tga_s1_s2_qoi_cdf_0_system_confidence_b.png
waitforbuttonpress;
clf
