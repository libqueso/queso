...
//********************************************************
// Likelihood function object for one validation problem stage (with prefix "stage0_").
...
//********************************************************
// QoI function object for one validation problem stage (with prefix "stage0_").
