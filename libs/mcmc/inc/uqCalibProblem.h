...
#define UQ_CALIB_PROBLEM_CALIB_DISTR_CALCULATOR_ODV  "BMC_DC" // Bayesian Markov Chain Distribution Calculator
...
template<class P_V,class P_M,class L_V,class L_M,class Q_V,class Q_M>
std::ostream& operator<<(std::ostream& os, const uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>& obj);

template <class P_V,class P_M,class L_V,class L_M,class Q_V,class Q_M>
uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::uqCalibProblemClass(
  ...
  m_calibDistrCalculator         (UQ_CALIB_PROBLEM_CALIB_DISTR_CALCULATOR_ODV ),
  ...
  m_mcDc                         (NULL)
{
  if (m_env.rank() == 0) std::cout << "Entering uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::constructor()"
                                   << ": prefix = " << m_prefix
                                   << std::endl;
  ...
  if (m_env.rank() == 0) std::cout << "In uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::constructor()"
  ...
  if (m_env.rank() == 0) std::cout << "Leaving uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::constructor()"
                                   << ": prefix = " << m_prefix
                                   << std::endl;
}
...
template<class P_V,class P_M,class L_V,class L_M,class Q_V,class Q_M>
void
uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::defineMyOptions(
  po::options_description& optionsDesc)
{
  optionsDesc.add_options()
    (m_option_help.c_str(),                                                                                                                "produce help message for CP problem")
    (m_option_calib_distrCalculator.c_str(),  po::value<std::string>()->default_value(UQ_CALIB_PROBLEM_CALIB_DISTR_CALCULATOR_ODV ), "algorithm for calibration"                        )
  ;
...
template<class P_V,class P_M,class L_V,class L_M,class Q_V,class Q_M>
void
  uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::getMyOptionValues(
  po::options_description& optionsDesc)
{
...
template <class P_V,class P_M,class L_V,class L_M,class Q_V,class Q_M>
void
uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::solve()
{
...
template <class P_V,class P_M,class L_V,class L_M,class Q_V,class Q_M>
void
uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::solve(const uqProbDensity_BaseClass<P_V,P_M>& priorParamDensityObj)
{
...
uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::paramSpace() const
{
  return *m_paramSpace;
}
...
uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::posteriorParamDensityObj() const
{
  UQ_FATAL_TEST_MACRO(m_posteriorParamDensityObj == NULL,
                      m_env.rank(),
                      "uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::posteriorParamDensityObj()",
...
uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::posteriorParamGeneratorObj() const
{
...
uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::observableSpace() const
{
...
template <class P_V,class P_M,class L_V,class L_M,class Q_V,class Q_M>
void
uqCalibProblemClass<P_V,P_M,L_V,L_M,Q_V,Q_M>::print(std::ostream& os) const
{
