...
uqMLSamplingLevelOptionsClass::uqMLSamplingLevelOptionsClass(
  ...
  m_minEffectiveSizeRatio            (inputOptions.m_minEffectiveSizeRatio),
...
#if 0
void
uqMLSamplingLevelOptionsClass::changePrefix(const char* prefix)
{
  m_prefix                                    = (std::string)(prefix) + ""                     ;
  m_option_help                               = m_prefix + "help"                              ;
  m_option_dataOutputFileName                 = m_prefix + "dataOutputFileName"                ;
...
uqMLSamplingLevelOptionsClass::copyOptionsValues(const uqMLSamplingLevelOptionsClass& srcOptions)
{
  ...
  m_rawChainType                      = srcOptions.m_rawChainType;
...
//std::cout << "In copy(), rawChainSize = " << m_rawChainSize << std::endl;
  ...
  m_filteredChainStatOptsInstantiated = false;
  m_mhDisplayCandidates               = srcOptions.m_mhDisplayCandidates;
  m_mhPutOutOfBoundsInChain           = srcOptions.m_mhPutOutOfBoundsInChain;
...
uqMLSamplingLevelOptionsClass::defineMyOptions(po::options_description& optionsDesc) const
{
  optionsDesc.add_options()     
    ...
    (m_option_dr_listOfScalesForExtraStages.c_str(),      po::value<std::string >()->default_value(UQ_ML_SAMPLING_L_DR_LIST_OF_SCALES_FOR_EXTRA_STAGES_ODV    ), "'dr' list of scales for proposal cov matrices from 2nd stage on" )
    ...
    (m_option_rawChain_type.c_str(),                      po::value<unsigned int>()->default_value(m_rawChainType                     ), "type of raw chain (1=Markov, 2=White noise)"                     )
    ...
    (m_option_mh_displayCandidates.c_str(),               po::value<bool        >()->default_value(m_mhDisplayCandidates              ), "display candidates generated in the core MH algorithm"           )
    (m_option_mh_putOutOfBoundsInChain.c_str(),           po::value<bool        >()->default_value(m_mhPutOutOfBoundsInChain          ), "put 'out of bound' candidates in chain as well"                  )
