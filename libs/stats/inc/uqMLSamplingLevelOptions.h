...
#define UQ_ML_SAMPLING_L_MIN_EFFECTIVE_SIZE_RATIO_ODV               0.05
#define UQ_ML_SAMPLING_L_MAX_EFFECTIVE_SIZE_RATIO_ODV               0.15
#define UQ_ML_SAMPLING_L_SCALE_COV_MATRIX_ODV                       1
#define UQ_ML_SAMPLING_L_MIN_REJECTION_RATE_ODV                     0.30
