...
headers=`find ../../src -name "*.h" -a -not -name all.h -a -not -name FiniteDistribution.h -a -not -name DiscreteSubset.h -type f | grep -v 'ANN' | grep -v 'interface' | LC_COLLATE=POSIX sort`
