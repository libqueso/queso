...
plot(ip_mc_rawChain_corrViaFftLags_sub0,ip_mc_rawChain_corrViaFftInitPos0_sub0(1,:),'-b','linewidth',2);
hold
plot(ip_mc_filtChain_corrViaFftLags_sub0,ip_mc_filtChain_corrViaFftInitPos0_sub0(1,:),'-r','linewidth',2);
...
plot(ip_mc_rawChain_corrViaFftLags_sub0,ip_mc_rawChain_corrViaFftInitPos0_sub0(2,:),'-b','linewidth',2);
hold
plot(ip_mc_filtChain_corrViaFftLags_sub0,ip_mc_filtChain_corrViaFftInitPos0_sub0(2,:),'-r','linewidth',2);
...
plot(ip_mc_filtChain_unifGkdePosits_sub0(1,:),ip_mc_filtChain_unifGkdeValues_sub0(1,:),'-b','linewidth',2);
hold
x = ip_mc_filtChain_unifGkdePosits_sub0(1,:);
...
plot(ip_mc_filtChain_unifGkdePosits_sub0(2,:),ip_mc_filtChain_unifGkdeValues_sub0(2,:),'-b','linewidth',2);
hold
x = ip_mc_filtChain_unifGkdePosits_sub0(2,:);
