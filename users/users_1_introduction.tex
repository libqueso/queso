...
An application using QUESO will fall into three categories: a statistical IP, a statistical FP, or combinations of both.
...
physics 
%model
knowledge in the model library, and relevant calibration
    and validation data.
