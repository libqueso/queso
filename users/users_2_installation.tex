...
This chapter describe how to install QUESO, test it and use it to build your application.
...
%
\begin{enumerate}
\item {install five packages: % item 1
\begin{itemize}
...
\item {prepare your LINUX environment (assuming csh; some commands might be enough): % item 2
\begin{itemize}
...
\section{The Installed Directory Structure} \label{sc-intalled-dir-structure}
