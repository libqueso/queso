  ...
  : uqLibMeshOperatorBase(builder, m)
{
  ...
  CondensedEigenSystem & eigen_system =
    es->get_system<CondensedEigenSystem>("Eigensystem");
  ...
  ZeroFunction<> zf;
  DirichletBoundary dirichlet_bc(boundary_ids, vars, &zf);
  ...
  set<unsigned int> global_dirichlet_dof_ids;
  DofConstraints::const_iterator it =
