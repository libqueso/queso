...
#ifndef QUESO_EXPERIMENT_METRIC_EIG
#define QUESO_EXPERIMENT_METRIC_EIG
...
namespace QUESO
{
  ...
  class ExperimentMetricEIG : public ExperimentMetricBase<V,M>
  {
  public:
...
#endif //QUESO_EXPERIMENT_METRIC_EIG
