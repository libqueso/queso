...
public:
  ...
  * where \c kdeDimension is the  KDE dimension.  */
   ...
   * uqFilePtrSetStruct& filePtrSet, const std::string& fileType). */
  ...
  //! Writes the sub-sequence to a file. 
  /*! Uses additional variable of the type uqFilePtrSetStruct& to operate on files. */
  void         subWriteContents           (unsigned int                         initialPos,
                                           unsigned int                         numPos,
  ...
  //! Reads the unifed sequence from a file. 
