...
public:
  ...
  //@{ 
  //! Default constructor.
  BaseVectorSequenceClass(const VectorSpaceClass<V,M>& vectorSpace,
			    unsigned int                   subSequenceSize,
			    const std::string&             name);
  //! Destructor.
  virtual ~BaseVectorSequenceClass();
  //@}
  ...
  //! Vector space; access to protected attribute VectorSpaceClass<V,M>& m_vectorSpace.
  ...
  const    BoxSubsetClass<V,M>&   subBoxPlain        () const;
  ...
  const    BoxSubsetClass<V,M>&   unifiedBoxPlain    () const;
  ...
  void                     append                      (const BaseVectorSequenceClass<V,M>& src,
							unsigned int                    initialPos,
							unsigned int                    numPos); 
  //! Finds the positions where the maximum element occurs in the sub-sequence.
  double                   subPositionsOfMaximum       (const ScalarSequenceClass<double>& subCorrespondingScalarValues,
							BaseVectorSequenceClass<V,M>&      subPositionsOfMaximum);
   
  //! Finds the positions where the maximum element occurs in the unified sequence.
  double                   unifiedPositionsOfMaximum   (const ScalarSequenceClass<double>& subCorrespondingScalarValues,
							BaseVectorSequenceClass<V,M>&      unifiedPositionsOfMaximum);
...
//virtual  void           fftInverse                  (unsigned int                             fftSize) = 0;
  ...
  void                    computeHistCdfstaccKde      (const SequenceStatisticalOptionsClass& statisticalOptions,
						       std::ofstream*                           passedOfs);

  void                    computeStatistics           (const SequenceStatisticalOptionsClass& statisticalOptions,
						       std::ofstream*                           passedOfs);
  ...
  virtual  void           subUniformlySampledMdf      (const V&                       numEvaluationPointsVec,
						       ...
						       ArrayOfOneDTablesClass<V,M>& mdfValues) const = 0;
...
protected:
  ...
  /*! This routine deletes all stored computed vectors */
  void           copy                        (const BaseVectorSequenceClass<V,M>&    src); 
  ...
  mutable FftClass<double>*    m_fftObj;
  ...
  mutable BoxSubsetClass<V,M>* m_subBoxPlain;
  mutable BoxSubsetClass<V,M>* m_unifiedBoxPlain;
  ...
  virtual  void           unifiedMeanMonitorFree      () = 0;
           ...
           void           computeMeanEvolution        (const SequenceStatisticalOptionsClass& statisticalOptions,
						       std::ofstream*                           passedOfs);
#endif
	   
#ifdef QUESO_COMPUTES_EXTRA_POST_PROCESSING_STATISTICS
           void           computeBMM                  (const SequenceStatisticalOptionsClass& statisticalOptions,
                                                       const std::vector<unsigned int>&         initialPosForStatistics,
                                                       std::ofstream*                           passedOfs);
           void           computeFFT                  (const SequenceStatisticalOptionsClass& statisticalOptions,
                                                       const std::vector<unsigned int>&         initialPosForStatistics,
                                                       std::ofstream*                           passedOfs);
           void           computePSD                  (const SequenceStatisticalOptionsClass& statisticalOptions,
                                                       const std::vector<unsigned int>&         initialPosForStatistics,
                                                       std::ofstream*                           passedOfs);
           void           computePSDAtZero            (const SequenceStatisticalOptionsClass& statisticalOptions,
                                                       const std::vector<unsigned int>&         initialPosForStatistics,
                                                       std::ofstream*                           passedOfs);
           void           computeGeweke               (const SequenceStatisticalOptionsClass& statisticalOptions,
                                                       const std::vector<unsigned int>&         initialPosForStatistics,
                                                       std::ofstream*                           passedOfs);
           void           computeMeanStacc            (const SequenceStatisticalOptionsClass& statisticalOptions,
                                                       const std::vector<unsigned int>&         initialPosForStatistics,
                                                       std::ofstream*                           passedOfs);
#endif
	   
#ifdef QUESO_USES_SEQUENCE_STATISTICAL_OPTIONS
           void           computeMeanVars             (const SequenceStatisticalOptionsClass& statisticalOptions,
                                                       std::ofstream*                           passedOfs,
                                                       V*                                       subMeanPtr,
                                                       V*                                       subMedianPtr,
                                                       V*                                       subSampleVarPtr,
                                                       V*                                       subPopulVarPtr);
           void           computeAutoCorrViaDef       (const SequenceStatisticalOptionsClass& statisticalOptions,
                                                       const std::vector<unsigned int>&         initialPosForStatistics,
                                                       const std::vector<unsigned int>&         lagsForCorrs,
                                                       std::ofstream*                           passedOfs);
           void           computeAutoCorrViaFFT       (const SequenceStatisticalOptionsClass& statisticalOptions,
                                                       const std::vector<unsigned int>&         initialPosForStatistics,
                                                       const std::vector<unsigned int>&         lagsForCorrs,
                                                       std::ofstream*                           passedOfs);
           void           computeCovCorrMatrices      (const SequenceStatisticalOptionsClass& statisticalOptions,
                                                       std::ofstream*                           passedOfs);
#endif
...
// Default constructor -----------------------------
template <class V, class M>
BaseVectorSequenceClass<V,M>::BaseVectorSequenceClass(
  ...
  m_name                      (name),
  m_fftObj                    (new FftClass<double>(m_env)),
  m_subMinPlain               (NULL),
...
template <class V, class M>
unsigned int
BaseVectorSequenceClass<V,M>::unifiedSequenceSize() const
{
  ...
  if (useOnlyInter0Comm) {
    if (m_env.inter0Rank() >= 0) {
      ...
      m_env.inter0Comm().Allreduce((void *) &subNumSamples, (void *) &unifiedNumSamples, (int) 1, RawValue_MPI_UNSIGNED, RawValue_MPI_SUM,
                                   "BaseVectorSequenceClass<V,M>::unifiedSequenceSize()",
...
template <class V, class M>
unsigned int
BaseVectorSequenceClass<V,M>::vectorSizeLocal() const
{
...
template <class V, class M>
unsigned int
BaseVectorSequenceClass<V,M>::vectorSizeGlobal() const
{
...
BaseVectorSequenceClass<V,M>::vectorSpace() const
{
...
template <class V, class M>
const std::string&
BaseVectorSequenceClass<V,M>::name() const
{
  return m_name;
}
// --------------------------------------------------
template <class V, class M>
void
BaseVectorSequenceClass<V,M>::setName(const std::string& newName)
{
  m_name = newName;
  return;
}
...
template <class V, class M>
void
BaseVectorSequenceClass<V,M>::clear()
{
...
template <class V, class M>
const V&
BaseVectorSequenceClass<V,M>::subMinPlain() const
{
...
template <class V, class M>
const V&
BaseVectorSequenceClass<V,M>::unifiedMinPlain() const
{
...
template <class V, class M>
const V&
BaseVectorSequenceClass<V,M>::subMaxPlain() const
{
...
template <class V, class M>
const V&
BaseVectorSequenceClass<V,M>::unifiedMaxPlain() const
{
...
template <class V, class M>
const V&
BaseVectorSequenceClass<V,M>::subMeanPlain() const
{
...
template <class V, class M>
const V&
BaseVectorSequenceClass<V,M>::unifiedMeanPlain() const
{
...
template <class V, class M>
const V&
BaseVectorSequenceClass<V,M>::subMedianPlain() const
{
...
template <class V, class M>
const V&
BaseVectorSequenceClass<V,M>::unifiedMedianPlain() const
{
...
template <class V, class M>
const V&
BaseVectorSequenceClass<V,M>::subSampleVariancePlain() const
{
...
template <class V, class M>
const V&
BaseVectorSequenceClass<V,M>::unifiedSampleVariancePlain() const
{
...
// --------------------------------------------------
template <class V, class M>
const BoxSubsetClass<V,M>&
BaseVectorSequenceClass<V,M>::subBoxPlain() const
{
  if (m_subBoxPlain == NULL) {
    m_subBoxPlain = new BoxSubsetClass<V,M>(m_name.c_str(),
                                              m_vectorSpace,
                                              this->subMinPlain(),
                                              this->subMaxPlain());
  }
...
template <class V, class M>
const BoxSubsetClass<V,M>&
BaseVectorSequenceClass<V,M>::unifiedBoxPlain() const
{
  if (m_unifiedBoxPlain == NULL) {
    m_unifiedBoxPlain = new BoxSubsetClass<V,M>(m_name.c_str(),
                                                  m_vectorSpace,
...
template <class V, class M>
void
BaseVectorSequenceClass<V,M>::append(
  const BaseVectorSequenceClass<V,M>& src,
  unsigned int                          initialPos,
  unsigned int                          numPos)
{
...
double
BaseVectorSequenceClass<V,M>::subPositionsOfMaximum(
  const ScalarSequenceClass<double>& subCorrespondingScalarValues,
  BaseVectorSequenceClass<V,M>&      subPositionsOfMaximum)
{
  if (m_env.subDisplayFile()) {
    *m_env.subDisplayFile() << "Entering BaseVectorSequenceClass<V,M>::subPositionsOfMaximum()"
  ...
  if (m_env.subDisplayFile()) {
    *m_env.subDisplayFile() << "Leaving BaseVectorSequenceClass<V,M>::subPositionsOfMaximum()"
                            << std::endl;
  }
...
template <class V, class M>
double
BaseVectorSequenceClass<V,M>::unifiedPositionsOfMaximum( // rr0
  const ScalarSequenceClass<double>& subCorrespondingScalarValues,
  BaseVectorSequenceClass<V,M>&      unifiedPositionsOfMaximum)
{
  if (m_env.subDisplayFile()) {
    *m_env.subDisplayFile() << "Entering BaseVectorSequenceClass<V,M>::unifiedPositionsOfMaximum()"
                            << ": subCorrespondingScalarValues,subSequenceSize() = " << subCorrespondingScalarValues.subSequenceSize()
                            << ", this->subSequenceSize = " << this->subSequenceSize()
                            << std::endl;
  }
  ...
  if (m_env.subDisplayFile()) {
    *m_env.subDisplayFile() << "Leaving BaseVectorSequenceClass<V,M>::unifiedPositionsOfMaximum()"
                            << std::endl;
  }
...
template <class V, class M>
void
BaseVectorSequenceClass<V,M>::setGaussian(const V& meanVec, const V& stdDevVec)
{
...
template <class V, class M>
void
BaseVectorSequenceClass<V,M>::setUniform(const V& aVec, const V& bVec)
{
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeFilterParams(
  std::ofstream* passedOfs,
  unsigned int&  initialPos,
  unsigned int&  spacing)
{
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeStatistics(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  std::ofstream*                           passedOfs)
{
  if (m_env.subDisplayFile()) {
    *m_env.subDisplayFile() << "\n"
  ...
  for (unsigned int i = 0; i < initialPosForStatistics.size(); ++i) {
    ...
    if (m_env.subDisplayFile()) {
      *m_env.subDisplayFile() << "In BaseVectorSequenceClass<V,M>::computeStatistics()"
  ...
  if (m_env.subDisplayFile()) {
    *m_env.subDisplayFile() << "In BaseVectorSequenceClass<V,M>::computeStatistics(): initial positions for statistics =";
    for (unsigned int i = 0; i < initialPosForStatistics.size(); ++i) {
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeMeanVars(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  std::ofstream*                           passedOfs,
  V*                                       subMeanPtr,
  V*                                       subMedianPtr,
  ...
  V*                                       subPopulVarPtr)
{
  ...
  if ((m_env.displayVerbosity() >= 5) && (m_env.subDisplayFile())) {
    *m_env.subDisplayFile() << "In BaseVectorSequenceClass<V,M>::computeMeanVars()"
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeAutoCorrViaDef(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  const std::vector<unsigned int>&      initialPosForStatistics,
  const std::vector<unsigned int>&      lagsForCorrs,
  std::ofstream*                        passedOfs)
{
  ...
  if (statisticalOptions.autoCorrDisplay() && (m_env.subDisplayFile())) {
    *m_env.subDisplayFile() << "In BaseVectorSequenceClass<V,M>::computeAutoCorrViaDef(): lags for autocorrelation (via def) = ";
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeAutoCorrViaFFT(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  const std::vector<unsigned int>&      initialPosForStatistics,
  const std::vector<unsigned int>&      lagsForCorrs,
  std::ofstream*                        passedOfs)
{
  ...
  if (statisticalOptions.autoCorrDisplay() && (m_env.subDisplayFile())) {
    *m_env.subDisplayFile() << "In BaseVectorSequenceClass<V,M>::computeAutoCorrViaFFT(): lags for autocorrelation (via fft) = ";
    for (unsigned int i = 0; i < lagsForCorrs.size(); ++i) {
      *m_env.subDisplayFile() << " " << lagsForCorrs[i];
     }
     *m_env.subDisplayFile() << std::endl;
  ...
  for (unsigned int initialPosId = 0; initialPosId < initialPosForStatistics.size(); initialPosId++) {
    ...
    if (m_env.subDisplayFile()) {
      *m_env.subDisplayFile() << "In BaseVectorSequenceClass<V,M>::computeAutoCorrViaFFT()"
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeHistCdfstaccKde( // Use the whole chain
  const SequenceStatisticalOptionsClass& statisticalOptions,
  std::ofstream*                           passedOfs)
{
  if (m_env.subDisplayFile()) {
  ...
  if (m_env.numSubEnvironments() > 1) {
    ...
    if (m_env.subDisplayFile()) {
      if (m_vectorSpace.numOfProcsForStorage() == 1) {
        ...
        UQ_FATAL_TEST_MACRO(true,
                            m_env.worldRank(),
                            "BaseVectorSequenceClass<V,M>::computeHistCdfstaccKde()",
                            "unified min-max writing, parallel vectors not supported yet");
      }
    } // if subDisplayFile
  } // if numSubEnvs > 1
  ...
  if ((statisticalOptions.kdeCompute()             ) &&
    ...
    if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() > 10)) { // output debug
      *m_env.subDisplayFile() << "In BaseVectorSequenceClass<V,M>::computeHistCdfstaccKde()"
                              << ", for chain '" << m_name << "'"
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeCovCorrMatrices( // Use the whole chain
  const SequenceStatisticalOptionsClass& statisticalOptions,
  std::ofstream*                           passedOfs)
{
  if (m_env.subDisplayFile()) {
  ...
  if (m_env.subDisplayFile()) {
    if (m_vectorSpace.numOfProcsForStorage() == 1) {
      ...
      if (m_env.inter0Rank() == 0) {
        *m_env.subDisplayFile() << "\nBaseVectorSequenceClass<V,M>::computeCovCorrMatrices"
                                << ", chain " << m_name
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeMeanEvolution(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  std::ofstream*                           passedOfs)
{
  int iRC = UQ_OK_RC;
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeBMM(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  const std::vector<unsigned int>&      initialPosForStatistics,
  std::ofstream*                        passedOfs)
{
  ...
  if (m_env.subDisplayFile()) {
    *m_env.subDisplayFile() << "In BaseVectorSequenceClass<V,M>::computeBMM(): lengths for batchs in BMM =";
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeFFT(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  const std::vector<unsigned int>&      initialPosForStatistics,
  std::ofstream*                        passedOfs)
{
  ...
  FftClass<std::complex<double> > fftObj(m_env);
  for (unsigned int initialPosId = 0; initialPosId < initialPosForStatistics.size(); initialPosId++) {
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computePSD(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  const std::vector<unsigned int>&      initialPosForStatistics,
  std::ofstream*                        passedOfs)
{
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computePSDAtZero(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  const std::vector<unsigned int>&      initialPosForStatistics,
  std::ofstream*                        passedOfs)
{
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeGeweke(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  const std::vector<unsigned int>&      initialPosForStatistics,
  std::ofstream*                        passedOfs)
{
...
template<class V, class M>
void
BaseVectorSequenceClass<V,M>::computeMeanStacc(
  const SequenceStatisticalOptionsClass& statisticalOptions,
  const std::vector<unsigned int>&      initialPosForStatistics,
  std::ofstream*                        passedOfs)
{
...
ComputeCovCorrMatricesBetweenVectorSequences(
  const BaseVectorSequenceClass<P_V,P_M>& subPSeq,
  const BaseVectorSequenceClass<Q_V,Q_M>& subQSeq,
        unsigned int                        subNumSamples,
        P_M&                                pqCovMatrix,
        P_M&                                pqCorrMatrix)
{
  // Check input data consistency
  const BaseEnvironmentClass& env = subPSeq.vectorSpace().zeroVector().env();
