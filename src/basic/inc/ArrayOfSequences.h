...
template <class V, class M>
unsigned int
ArrayOfSequences<V,M>::subSequenceSize() const
{
...
template <class V, class M>
void
ArrayOfSequences<V,M>::resizeSequence(unsigned int newSubSequenceSize)
{
...
template <class V, class M>
void
ArrayOfSequences<V,M>::resetValues(
...
template <class V, class M>
void
ArrayOfSequences<V,M>::erasePositions(
  unsigned int initialPos,
  unsigned int numPos)
{
...
template <class V, class M>
void
ArrayOfSequences<V,M>::getPositionValues(unsigned int posId, V& vec) const
{
  ArrayOfSequences<V,M>* tmp = const_cast<ArrayOfSequences<V,M>*>(this);
  for (unsigned int i = 0; i < (unsigned int) m_scalarSequences.MyLength(); ++i) {
...
template <class V, class M>
void
ArrayOfSequences<V,M>::setPositionValues(unsigned int posId, const V& vec)
{
  for (unsigned int i = 0; i < (unsigned int) m_scalarSequences.MyLength(); ++i) {
    ScalarSequence<double>& seq = *(m_scalarSequences(i,0));
    seq[posId] = vec[i];
...
template <class V, class M>
void
ArrayOfSequences<V,M>::setGaussian(const V& meanVec, const V& stdDevVec)
{
  for (unsigned int i = 0; i < (unsigned int) m_scalarSequences.MyLength(); ++i) {
    ScalarSequence<double>& seq = *(m_scalarSequences(i,0));
...
template <class V, class M>
void
ArrayOfSequences<V,M>::setUniform(const V& aVec, const V& bVec)
{
  for (unsigned int i = 0; i < (unsigned int) m_scalarSequences.MyLength(); ++i) {
    ScalarSequence<double>& seq = *(m_scalarSequences(i,0));
...
template <class V, class M>
void
ArrayOfSequences<V,M>::autoCovariance(
  unsigned int initialPos,
  unsigned int numPos,
  const V&     meanVec,
  unsigned int lag,
...
template <class V, class M>
void
ArrayOfSequences<V,M>::autoCorrViaDef(
  unsigned int initialPos,
  unsigned int numPos,
  unsigned int lag,
  V&           corrVec) const
...
template <class V, class M>
void
ArrayOfSequences<V,M>::autoCorrViaFft(
  unsigned int                     initialPos,
  unsigned int                     numPos,
  const std::vector<unsigned int>& lags,
  std::vector<V*>&                 corrVecs) const
...
template <class V, class M>
void
ArrayOfSequences<V,M>::histogram(
  unsigned int     initialPos,
  const V&         minVec,
  const V&         maxVec,
  std::vector<V*>& centersForAllBins,
...
template <class V, class M>
void
ArrayOfSequences<V,M>::interQuantileRange(
  unsigned int initialPos,
  V&           iqrs) const
{
#if 0
...
template <class V, class M>
void
ArrayOfSequences<V,M>::scalesForKDE(
  unsigned int initialPos,
  const V&     iqrs,
  unsigned int kdeDimension,
  V&           scales) const
...
template <class V, class M>
void
ArrayOfSequences<V,M>::gaussianKDE(
...
template <class V, class M>
void
ArrayOfSequences<V,M>::writeContents(std::ofstream& ofsvar) const
{
  // Write chain
...
template <class V, class M>
void
ArrayOfSequences<V,M>::unifiedWriteContents(std::ofstream& ofsvar) const
{
...
template <class V, class M>
void
ArrayOfSequences<V,M>::unifiedWriteContents(
...
template <class V, class M>
void
ArrayOfSequences<V,M>::select(const std::vector<unsigned int>& idsOfUniquePositions)
{
  return;
}
// --------------------------------------------------
...
template <class V, class M>
void
ArrayOfSequences<V,M>::extractScalarSeq(
  unsigned int                   initialPos,
  unsigned int                   spacing,
  unsigned int                   numPos,
  unsigned int                   paramId,
...
template <class V, class M>
void
ArrayOfSequences<V,M>::extractRawData(
  unsigned int         initialPos,
  unsigned int         spacing,
  unsigned int         numPos,
  unsigned int         paramId,
...
template <class V, class M>
void
ArrayOfSequences<V,M>::uniformlySampledCdf(
...
template <class V, class M>
void
ArrayOfSequences<V,M>::fftForward(
  unsigned int                        initialPos,
  unsigned int                        fftSize,
  unsigned int                        paramId,
  std::vector<std::complex<double> >& resultData) const
...
template <class V, class M>
void
ArrayOfSequences<V,M>::psdAtZero(
  unsigned int initialPos,
  unsigned int numBlocks,
  double       hopSizeRatio,
  V&           psdVec) const
