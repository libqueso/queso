...
public:
  ...
  GcmZInfoClass(bool                                                             formCMatrix,
  ...
  GcmZInfoClass(bool                                                             allOutputsAreScalar,
                  const GcmSimulationInfoClass<S_V,S_M,P_V,P_M,Q_V,Q_M>&         s,
                  const GcmExperimentInfoClass<S_V,S_M,D_V,D_M,P_V,P_M>&         e);
 ~GcmZInfoClass();
  ...
  const BaseEnvironmentClass&     m_env;
        ...
        VectorSpaceClass<D_V,D_M> m_z_space;
        D_V                         m_Zvec_hat;
...
// Case with no experiments
template <class S_V,class S_M,class D_V,class D_M,class P_V,class P_M,class Q_V,class Q_M>
GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::GcmZInfoClass(
  bool                                                     formCMatrix,
  bool                                                     allOutputsAreScalar,
  const GcmSimulationInfoClass<S_V,S_M,P_V,P_M,Q_V,Q_M>& s)
  :
  ...
  m_tmp_Smat_z_hat_inv(m_z_space.zeroVector())
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "Entering GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::constructor(1)"
                            << std::endl;
  }
  ...
  UQ_FATAL_TEST_MACRO(m_z_space.dimLocal() != (s.m_paper_m * s.m_paper_p_eta),
                      m_env.worldRank(),
                      "GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::constructor(1)",
                      "incompatible calculations for 'z' vector size (1)");

  commonConstructor();

  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "Leaving GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::constructor(1)"
                            << std::endl;
  }
}
...
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "Entering GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::constructor(2)"
                            << std::endl;
  }

  UQ_FATAL_TEST_MACRO(allOutputsAreScalar == true,
                      m_env.worldRank(),
                      "GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::constructor(2)",
  ...
  if (formCMatrix) {
    ...
    if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 3)) {
      *m_env.subDisplayFile() << "In GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::constructor(2)"
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "Leaving GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::constructor(2)"
                            << std::endl;
  }
}
...
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "Entering GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::constructor(3)"
                            << std::endl;
  }

  UQ_FATAL_TEST_MACRO(allOutputsAreScalar == false,
                      m_env.worldRank(),
                      "GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::constructor(3)",
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "Leaving GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::constructor(3)"
                            << std::endl;
  }
}
...
template <class S_V,class S_M,class D_V,class D_M,class P_V,class P_M,class Q_V,class Q_M>
void
GcmZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::commonConstructor()
{
  //********************************************************************************
  // Display information
  //********************************************************************************
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "In GcnZInfoClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::commonConstructor()"
