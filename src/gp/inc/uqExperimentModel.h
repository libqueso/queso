...
{
public:
  uqExperimentModelClass(const char*                                      prefix,
                         const uqEmOptionsValuesClass*                    alternativeOptionsValues, // dakota
 ...
 ~uqExperimentModelClass();
  ...
  const uqExperimentModelOptionsClass& optionsObj    () const;
        void                           print         (std::ostream& os) const;

private:
  // Private variables
  const uqBaseEnvironmentClass&           m_env;
        uqEmOptionsValuesClass            m_alternativeOptionsValues;
        uqExperimentModelOptionsClass*    m_optionsObj;
        ...
        uqVectorSpaceClass<D_V,D_M>*      m_n_y_space;      // to be deleted on destructor
        D_M*                              m_Dmat_BlockDiag; // to be deleted on destructor
};

template<class S_V,class S_M,class D_V,class D_M>
std::ostream& operator<<(std::ostream& os, const uqExperimentModelClass<S_V,S_M,D_V,D_M>& obj);

template<class S_V,class S_M,class D_V,class D_M>
uqExperimentModelClass<S_V,S_M,D_V,D_M>::uqExperimentModelClass(
  const char*                                      prefix,
  const uqEmOptionsValuesClass*                    alternativeOptionsValues, // dakota
  const uqExperimentStorageClass<S_V,S_M,D_V,D_M>& experimentStorage,
  const std::vector<D_M* >&                        Dmats,
  ...
  m_Dmat_BlockDiag          (NULL)
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "Entering uqExperimentModelClass<S_V,S_M,D_V,D_M>::constructor()"
                            << ": prefix = " << prefix
  ...
  if (m_env.optionsInputFileName() == "") {
    m_optionsObj = new uqExperimentModelOptionsClass(m_env,prefix,m_alternativeOptionsValues);
  }
  else {
    m_optionsObj = new uqExperimentModelOptionsClass(m_env,prefix);
    m_optionsObj->scanOptionsValues();
  }

  UQ_FATAL_TEST_MACRO(m_optionsObj->m_ov.m_Gvalues.size() < 1,
                      m_env.worldRank(),
                      "uqExperimentModelClass<S_V,S_M,D_V,D_M>::constructor()",
                      "invalid m_Gs");
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 3)) {
    *m_env.subDisplayFile() << "In uqExperimentModelClass<S_V,S_M,D_V,D_M>::constructor()"
                            << ": prefix = " << prefix
                            << "\n  m_paper_n_y = " << m_paper_n_y
                            << std::endl;
  }
  m_n_y_space = new uqVectorSpaceClass<D_V,D_M>(m_env, "n_y_", m_paper_n_y, NULL),
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "Leaving uqExperimentModelClass<S_V,S_M,D_V,D_M>::constructor()"
...
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "Entering uqExperimentModelClass<S_V,S_M,P_V,P_M,Q_V,Q_M>::destructor()..."
                            << std::endl;
  }
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 2)) {
    *m_env.subDisplayFile() << "Leaving uqExperimentModelClass<S_V,S_M,P_V,P_M,Q_V,Q_M>::destructor()"
                            << std::endl;
  }
}
...
template<class S_V,class S_M,class D_V,class D_M>
unsigned int
uqExperimentModelClass<S_V,S_M,D_V,D_M>::numBasis() const
{
...
template<class S_V,class S_M,class D_V,class D_M>
unsigned int
uqExperimentModelClass<S_V,S_M,D_V,D_M>::numBasisGroups() const
{
...
uqExperimentModelClass<S_V,S_M,D_V,D_M>::Gs() const
{
...
uqExperimentModelClass<S_V,S_M,D_V,D_M>::Kmats_interp() const
{
...
template<class S_V,class S_M,class D_V,class D_M>
const D_M&
uqExperimentModelClass<S_V,S_M,D_V,D_M>::Dmat(unsigned int basisId) const
{
...
template<class S_V,class S_M,class D_V,class D_M>
const D_M&
uqExperimentModelClass<S_V,S_M,D_V,D_M>::Dmat_BlockDiag() const
{
...
template<class S_V,class S_M,class D_V,class D_M>
const uqExperimentModelOptionsClass&
uqExperimentModelClass<S_V,S_M,D_V,D_M>::optionsObj() const
{
  return *m_optionsObj;
}
...
template<class S_V,class S_M,class D_V,class D_M>
void
uqExperimentModelClass<S_V,S_M,D_V,D_M>::print(std::ostream& os) const
{
  return;
}
