...
void
uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_hat(
        ...
        unsigned int outerCounter)
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Entering uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_hat(1)"
  ...
  UQ_FATAL_TEST_MACRO((m_optionsObj->m_ov.m_useTildeLogicForRankDefficientC == true),
                      m_env.worldRank(),
                      "uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_hat(1)",
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 99)) {
    *m_env.subDisplayFile() << "In uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_hat(1)"
                            << ", outerCounter = "           << outerCounter
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Leaving uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_hat(1)"
                            << ", outerCounter = " << outerCounter
                            << std::endl;
  }
...
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Entering uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_hat(2)"
                            << ", outerCounter = " << outerCounter
                            << ": m_formCMatrix = "                                        << m_formCMatrix
                            << ", m_optionsObj->m_ov.m_useTildeLogicForRankDefficientC = " << m_optionsObj->m_ov.m_useTildeLogicForRankDefficientC
                            << ", m_Cmat = "                                               << m_z->m_Cmat
  ...
  UQ_FATAL_TEST_MACRO((m_optionsObj->m_ov.m_useTildeLogicForRankDefficientC == true),
                      m_env.worldRank(),
                      "uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_hat(2)",
                      "'m_useTildeLogicForRankDefficientC' should be 'false'");
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 99)) {
    *m_env.subDisplayFile() << "In uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_hat(2)"
                            << ", outerCounter = "           << outerCounter
                            << ": finished forming 'm_tmp_Smat_z'"
                            << "\n m_tmp_Smat_z contents = " << m_z->m_tmp_Smat_z
                            << std::endl;
...
#endif
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Leaving uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_hat(2)"
                            << ", outerCounter = " << outerCounter
                            << std::endl;
  }
...
template <class S_V,class S_M,class D_V,class D_M,class P_V,class P_M,class Q_V,class Q_M>
void
uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_tilde_hat(
  const P_V&         input_1lambdaEtaVec,
  const P_V&         input_2lambdaWVec,
  const P_V&         input_3rhoWVec,
  const P_V&         input_4lambdaSVec,
...
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Entering uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_tilde_hat()"
                            << ", outerCounter = " << outerCounter
                            << ": m_formCMatrix = "                                        << m_formCMatrix
                            << ", m_optionsObj->m_ov.m_useTildeLogicForRankDefficientC = " << m_optionsObj->m_ov.m_useTildeLogicForRankDefficientC
                            << ", m_Cmat = "                                               << m_z->m_Cmat
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 99)) {
    *m_env.subDisplayFile() << "In uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_tilde_hat()"
                            << ", outerCounter = "           << outerCounter
                            << ": finished forming 'm_tmp_Smat_z'"
                            << "\n m_tmp_Smat_z contents = " << m_z->m_tmp_Smat_z
                            << std::endl;
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Leaving uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z_tilde_hat()"
                            << ", outerCounter = " << outerCounter
                            << std::endl;
  }
...
template <class S_V,class S_M,class D_V,class D_M,class P_V,class P_M,class Q_V,class Q_M>
void
uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z(
  const P_V&         input_2lambdaWVec,
  const P_V&         input_3rhoWVec,
  const P_V&         input_4lambdaSVec,
  const P_V&         input_6lambdaVVec,
...
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Entering uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z(1)"
                            << ", outerCounter = " << outerCounter
                            << std::endl;
  }
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "In uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z(1)"
                            << ", outerCounter = " << outerCounter
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Leaving uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z(1)"
                            << ", outerCounter = " << outerCounter
                            << std::endl;
  }
...
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Entering uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z(2)"
                            << ", outerCounter = " << outerCounter
                            << std::endl;
  }
  ...
  m_e->m_Smat_v.fillWithBlocksDiagonally(0,0,m_e->m_Smat_v_is,true,true);
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "In uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z(2)"
                            << ", outerCounter = " << outerCounter
                            << ": finished instantiating 'm_Smat_v'"
                            << std::endl;
  }
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Leaving uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_z(2)"
                            << ", outerCounter = " << outerCounter
                            << std::endl;
  }
...
template <class S_V,class S_M,class D_V,class D_M,class P_V,class P_M,class Q_V,class Q_M>
void
uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_w_hat(
  const P_V&         input_1lambdaEtaVec,
  const P_V&         input_2lambdaWVec,
  const P_V&         input_3rhoWVec,
  const P_V&         input_4lambdaSVec,
...
{
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Entering uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_w_hat()"
                            << ", outerCounter = " << outerCounter
                            << std::endl;
  }
  ...
  m_s->m_Smat_w.fillWithBlocksDiagonally(0,0,m_s->m_Smat_w_is,true,true);
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "In uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_w_hat()"
                            << ", outerCounter = " << outerCounter
                            << ": finished instantiating 'm_Smat_w'"
                            << std::endl;
  }
  ...
  if ((m_env.subDisplayFile()) && (m_env.displayVerbosity() >= 4)) {
    *m_env.subDisplayFile() << "Leaving uqGpmsaComputerModelClass<S_V,S_M,D_V,D_M,P_V,P_M,Q_V,Q_M>::formSigma_w_hat()"
                            << ", outerCounter = " << outerCounter
                            << std::endl;
  }
