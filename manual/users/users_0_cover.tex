...
The QUESO library is released as open source under Version 2.1 of the GNU
Lesser General Public License and is available for free download world-wide.
See https://www.gnu.org/licenses/lgpl-2.1.html for more information on the
LGPLv2.1 software use agreement.\\
